...
RSpec.describe Webhookdb::Services::StripeSubscriptionItemV1, :db do
  it_behaves_like "a service implementation", "stripe_subscription_item_v1" do
    let(:body) do
      JSON.parse(<<~J)
        {
  ...
  it_behaves_like "a service implementation that can backfill", "stripe_subscription_item_v1" do
