...
RSpec.describe Webhookdb::Services, :db do
  describe "increase ach transfer v1" do
    ...
    describe "state machine calculation" do
      ...
      describe "calculate_create_state_machine" do
        it "asks for webhook secret" do
          ...
          expect(state_machine.output).to match("We've made an endpoint available for Increase ACH Transfer webhooks:")
        end
        ...
        it "confirms reciept of webhook secret, returns org database info" do
          ...
          expect(state_machine.output).to match("Great! WebhookDB is now listening for Increase ACH Transfer webhooks.")
        end
      end
      describe "calculate_backfill_state_machine" do
        it "it asks for backfill key" do
          ...
          expect(state_machine.complete).to eq(false)
          expect(state_machine.output).to match("In order to backfill Increase ACH Transfers, we need an API key.")
        end
