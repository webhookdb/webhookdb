...
RSpec.describe Webhookdb::Services::StripePriceV1, :db do
  it_behaves_like "a service implementation", "stripe_price_v1" do
    let(:body) do
      JSON.parse(<<~J)
        {
          ...
          "data": {
            "object": {
              "id": "price_1KhEkZ2eZvKYlo2C9t0gLIdE",
              "object": "price",
              "active": true,
  ...
  it_behaves_like "a service implementation that prevents overwriting new data with old", "stripe_price_v1" do
    let(:old_body) do
      JSON.parse(<<~J)
        {
          "id": "evt_1CiPtv2eZvKYlo2CcUZsDcO6",
  ...
  it_behaves_like "a service implementation that deals with resources and wrapped events", "stripe_price_v1" do
  ...
  it_behaves_like "a service implementation that verifies backfill secrets" do
    ...
    def stub_service_request
      return stub_request(:get, "https://api.stripe.com/v1/prices").
  ...
  it_behaves_like "a service implementation that can backfill", "stripe_price_v1" do
      ...
      <<~R
        {
          ...
          "data": [
            ...
            {
              "id": "price_2KhEkZ2eZvKYlo2C9t0gLIdE",
              "object": "price",
              "active": true,
              "billing_scheme": "per_unit",
              "created": 1648220907,
            ...
            {
              "id": "price_3KhEkZ2eZvKYlo2C9t0gLIdE",
              "object": "price",
              "active": true,
              "billing_scheme": "per_unit",
              "created": 1648220907,
      ...
      <<~R
        {
          ...
          "data": [
            {
              "id": "price_4KhEkZ2eZvKYlo2C9t0gLIdE",
              "object": "price",
              "active": true,
              "billing_scheme": "per_unit",
              "created": 1648220907,
            ...
            {
              "id": "price_5KhEkZ2eZvKYlo2C9t0gLIdE",
              "object": "price",
              "active": true,
              "billing_scheme": "per_unit",
              "created": 1648220907,
            ...
            {
              "id": "price_6KhEkZ2eZvKYlo2C9t0gLIdE",
              "object": "price",
              "active": true,
              "billing_scheme": "per_unit",
              "created": 1648220907,
    ...
    def stub_service_requests
      return [
        ...
        stub_request(:get, "https://api.stripe.com/v1/prices?starting_after=price_3KhEkZ2eZvKYlo2C9t0gLIdE").
            to_return(status: 200, body: page2_response, headers: {"Content-Type" => "application/json"}),
        stub_request(:get, "https://api.stripe.com/v1/prices?starting_after=price_6KhEkZ2eZvKYlo2C9t0gLIdE").
  ...
  describe "webhook validation" do
    let(:sint) { Webhookdb::Fixtures.service_integration.create(service_name: "stripe_price_v1") }
    ...
    describe "calculate_create_state_machine" do
      it "asks for webhook secret" do
        ...
        expect(sm).to have_attributes(
          ...
          complete: false,
          output: match("We've made an endpoint available for Stripe Price webhooks:"),
        )
      end
      ...
      it "confirms reciept of webhook secret, returns org database info" do
        ...
        expect(sm).to have_attributes(
          ...
          post_to_url: "",
          complete: true,
          output: match("Great! WebhookDB is now listening for Stripe Price webhooks."),
        )
      end
    end
    ...
    describe "calculate_backfill_state_machine" do
      ...
      it "asks for backfill key" do
        ...
        expect(sm).to have_attributes(
          ...
          complete: false,
          output: match("In order to backfill Stripe Prices, we need an API key."),
        )
      end
      ...
      it "confirms reciept of backfill key, returns org database info" do
        ...
        expect(sm).to have_attributes(
          ...
          post_to_url: "",
          complete: true,
          output: match("Great! We are going to start backfilling your Stripe Prices."),
        )
      end
    end
  end
