...
export default function Terms() {
  return (
    <ContentPageLayout>
      ...
      <p>
        The webhookdb.com website and application (the "Site") is comprised of various
        web pages and desktop tools operated by Lithic Technology LLC (“Lithic
        Technology”) and is offered to you conditioned on your acceptance without
        modification of the terms, conditions, and notices contained herein (the
        "Terms"). Your use of the Site constitutes your agreement to all such Terms.
      ...
      <p>
        ...
        Technology provides to you electronically, via email and on the Site, satisfy
      ...
      <p>
        ...
        misappropriation of your account. Lithic Technology and its associates reserve
        the right to refuse or cancel service, terminate accounts, or remove or edit
      ...
      <p>
        ...
        without Lithic Technology’s prior written consent. Any attempt by you to assign
        or transfer these Terms, without such consent, will be null and of no effect.
        Lithic Technology may assign or transfer these Terms, at its sole discretion,
      ...
      <p>
        ...
        information from persons under the age of 13. If you are under the age of 18,
        you may use the Site only with permission of a parent or guardian.
      </p>
      ...
      <p>
        ...
        from the webhookdb.com domain, you hereby acknowledge and consent that Lithic
        Technology may share such information and data with any third party with whom
        Lithic Technology has a contractual relationship to provide the requested
      ...
      <p>
        ...
        and use the Site strictly in accordance with these terms of use. As a condition
        of your use of the Site, you warrant to Lithic Technology that you will not use
      ...
      <p>
        ...
        is the property of Lithic Technology or its suppliers and protected by copyright
      ...
      <p>
        ...
        content. Lithic Technology does not grant you any licenses, express or implied,
        to the intellectual property of Lithic Technology or our licensors except as
        expressly authorized by these Terms.
      </p>

      <h3>International Users</h3>
      <p>
        The Service is controlled, operated and administered by Lithic Technology from
        ...
        you will not use the Lithic Technology Content accessed through the Site in any
      ...
      <p>
        You agree to indemnify, defend and hold harmless Lithic Technology, its
        officers, directors, employees, agents and third parties, for any losses, costs,
        ...
        laws, rules or regulations. Lithic Technology reserves the right, at its own
        ...
        Lithic Technology in asserting any available defenses.
      </p>
      ...
      <p>
        ...
        "AS IS" WITHOUT WARRANTY OR CONDITION OF ANY KIND. LITHIC TECHNOLOGY AND/OR ITS
      ...
      <p>
        ...
        OTHERWISE, EVEN IF LITHIC TECHNOLOGY OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED OF
      ...
      <p>
        ...
        the Site. Lithic Technology's performance of this agreement is subject to
        existing laws and legal process, and nothing contained in this agreement is in
        derogation of Lithic Technology's right to comply with governmental, court and
        law enforcement requests or requirements relating to your use of the Site or
        information provided to or gathered by Lithic Technology with respect to such
      ...
      <p>
        ...
        agreement between the user and Lithic Technology with respect to the Site and it
        supersedes all prior or contemporaneous communications and proposals, whether
        electronic, oral or written, between the user and Lithic Technology with respect
      ...
      <p>
        Lithic Technology reserves the right, in its sole discretion, to change the
        Terms under which the Site is offered. The most current version of the Terms
        will supersede all previous versions. Lithic Technology encourages you to
